  ...
  class SpanOperation
    ...
    def measure(start_time: nil)
      ...
      # SignalException::Interrupt would still bubble up.
        ...
        # Capture the error and trigger the on_error event
    ...
    class Events
      ...
      def initialize
        ...
        on_error.subscribe(:default) do |span_op, error|
          DEFAULT_ON_ERROR.call(span_op, error)
        end
      end
    ...
    # Error when the span attempts to start again after being finished
    class AlreadyFinishedError < StandardError
      def message
        'Cannot measure an already finished span!'.freeze
      end
    end
  end
end
